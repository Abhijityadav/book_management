...
class BookController extends ControllerBase {
  ...
  /**
   * Constructs a new BookController object.
   *
  ...
  public function listBooks() {
    ...
    foreach ($nodes as $node) {
      $edit_url = Url::fromRoute('book_manager.edit', array('node' => $node->id()));
      $delete_url = Url::fromRoute('book_manager.delete', array('node' => $node->id()));
      $rows[] = [
        'data' => [
          'title' => $node->getTitle(),
